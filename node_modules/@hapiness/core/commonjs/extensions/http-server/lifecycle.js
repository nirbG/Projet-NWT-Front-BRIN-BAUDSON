...
class LifecycleManager {
    ...
    static routeLifecycle(server, routes) {
        server.ext(enums_1.LifecycleEventsEnum.OnPreAuth.toString(), (request, reply) => this.eventHandler(enums_1.LifecycleHooksEnum.OnPreAuth, routes, request, reply)
            .subscribe(_ => reply.continue(), _ => hapiness_1.errorHandler(_)));
        server.ext(enums_1.LifecycleEventsEnum.OnPostAuth.toString(), (request, reply) => this.instantiateRoute(routes, request, reply)
            .subscribe(_ => reply.continue(), _ => hapiness_1.errorHandler(_)));
    ...
    static instantiateRoute(routes, request, reply) {
        return rxjs_1.Observable
            ...
            .defaultIfEmpty(null)
            .flatMap(_ => this.eventHandler(enums_1.LifecycleHooksEnum.OnPostAuth, routes, request, reply));
    }
    /**
     ...
     * @returns boolean
     */
    static isRightLabels(labels = [], routeLabels = []) {
